...
export class SinglePartyCallComponent implements OnInit,OnDestroy {
  ...
  destination:any;
  constructor(private initialSetup: WebexService,private route: ActivatedRoute) {}

  ngOnInit(): void {
    this.initialSetup.onInit();
    this.onRegister()
    this.destination=this.route.snapshot.queryParamMap.get('roomID')
  }
